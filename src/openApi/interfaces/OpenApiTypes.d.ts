export namespace OpenAPI {
    ...
    // }>
    export type Document<T extends Record<string, unknown> = unknonw> = OpenAPIV2.Document<T> | OpenAPIV3.Document<T> | OpenAPIV3_1.Document<T>;
    export type Operation<T extends Record<string, unknown> = unknonw> = OpenAPIV2.OperationObject<T> | OpenAPIV3.OperationObject<T> | OpenAPIV3_1.OperationObject<T>;
...
export namespace OpenAPIV3_1 {
    ...
    type PathsWebhooksComponents<T extends Record<string, unknown> = unknonw> = {
        paths: PathsObject<T>;
        webhooks: Record<string, PathItemObject | ReferenceObject>;
        components: ComponentsObject;
    };

    export type Document<T extends Record<string, unknown> = unknonw> = Modify<
    ...
    export type PathsObject<T extends Record<string, unknown> = unknonw, P extends Record<string, unknown> = unknonw> = Record<string, (PathItemObject<T> & P) | undefined>;

    export type HttpMethods = OpenAPIV3.HttpMethods;

    export type PathItemObject<T extends Record<string, unknown> = unknonw> = Modify<
    ...
    export type OperationObject<T extends Record<string, unknown> = unknonw> = Modify<
...
export namespace OpenAPIV3 {
    export interface Document<T extends Record<string, unknown> = unknonw> {
        openapi: string;
        info: InfoObject;
        servers?: ServerObject[];
        paths: PathsObject<T>;
    ...
    export interface PathsObject<T extends Record<string, unknown> = unknonw, P extends Record<string, unknown> = unknonw> {
    ...
    export type PathItemObject<T extends Record<string, unknown> = unknonw> = {
        $ref?: string;
        summary?: string;
        description?: string;
        servers?: ServerObject[];
    ...
    export type OperationObject<T extends Record<string, unknown> = unknonw> = {
        tags?: string[];
        summary?: string;
        description?: string;
        externalDocs?: ExternalDocumentationObject;
...
export namespace OpenAPIV2 {
    ...
    export interface PathsObject<T extends Record<string, unknown> = unknonw> {
